...
optics_2025 = cms.PSet(
  validityRange = cms.EventRange("390950:min - 999999:max"),

  opticalFunctions = cms.VPSet(
    cms.PSet( xangle = cms.double(120.000), fileName = cms.FileInPath("CMS_PPS_Analysis/PPSReco/data/optical_functions/2026/120urad.root") ),
    cms.PSet( xangle = cms.double(160.000), fileName = cms.FileInPath("CMS_PPS_Analysis/PPSReco/data/optical_functions/2026/160urad.root") )
  ),
...
ctppsOpticalFunctionsESSource.configuration.append(optics_2025)
