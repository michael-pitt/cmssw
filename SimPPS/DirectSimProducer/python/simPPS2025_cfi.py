...
from SimPPS.DirectSimProducer.profiles_2025_cff import profile_2025_default
...
XMLIdealGeometryESSource_CTPPS, _ctppsGeometryESModule = cloneGeometry('Geometry.VeryForwardGeometry.geometryRPFromDD_2025_cfi')
